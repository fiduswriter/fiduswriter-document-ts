...
├── static-libs/          # Generated: MathLive CSS/fonts, PDF-export assets
│   │                     # (fallback fonts, woff2 wasm, ICC profile, paged
│   │                     # polyfill) — ships in the npm package
...
# static-libs/ is generated by prepare (below) or on publish:
pnpm run sync-static-libs
