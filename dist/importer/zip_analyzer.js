export class ZipAnalyzer {
    ...
    async getContents() {
        ...
        if (this.analysis.hasConvertible && this.analysis.convertibleFile) {
            const mainBlob = await this.analysis.convertibleFile.entry.async("blob");
            contents.mainContent = new File([mainBlob], this.analysis.convertibleFile.fileName);
        }
        // Load images
        const imagePromises = this.analysis.imageFiles.map(async ({ path, entry }) => {
...
//# sourceMappingURL=zip_analyzer.js.map