...
export class DOCXExporterFootnotes {
    ...
    init() {
        ...
        if (this.footnotes.length ||
            ...
            this.augmentedCitations = new DOCXExporterCitations(this.fnPmJSON, this.settings, this.bibDB, this.csl, this.xml, this.citations.citInfos);
            this.images = new DOCXExporterImages(this.fnPmJSON, this.imageDB, this.xml, this.fnRels);
            this.lists = new DOCXExporterLists(this.fnPmJSON, this.xml, this.fnRels);
    ...
    createXml() {
        ...
        this.richtext = new DOCXExporterRichtext(this.doc, this.settings, this.lists, this, this.math, this.tables, this.fnRels, this.augmentedCitations, this.images);
