...
export class DOCXExporterLists {
    ...
    addListParagraphStyle() {
        return this.xml.getXml(this.styleFilePath).then(styleXML => {
            ...
            if (!this.styleXML.query("w:style", { "w:styleId": "ListParagraph" })) {
    ...
    addUsedListTypes() {
        ...
        allAbstractNum.forEach(abstractNum => {
            ...
            const levelZeroFormat = levelZeroFormatEl
                ...
                : "";
            const abstractNumId = Number.parseInt(String(abstractNum.getAttribute("w:abstractNumId")));
        ...
        if (!this.bulletType && this.useBulletList) {
            this.addBulletNumType(++this.numIdCounter, ++this.abstractNumIdCounter);
