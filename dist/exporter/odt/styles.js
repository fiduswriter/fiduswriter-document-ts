...
export class ODTExporterStyles {
    ...
    getStyleCounters() {
        ...
        styles.forEach(style => {
            const styleNumber = Number.parseInt(String(style.getAttribute("style:name")).replace(/\D/g, ""));
    ...
    */
    ...
    checkParStyle(styleName) {
        ...
        if (!stylesParStyle && !contentParStyle) {
            ...
            stylesEl?.appendXML(PAR_STYLES[styleName] ||
    ...
    checkSectionStyle(styleName) {
        ...
        if (!stylesSection && !contentSection) {
            ...
            stylesEl?.appendXML(`<style:style style:name="${styleName}" style:family="section">
    ...
    */
    ...
    addListParStyle(_listId) {
        ...
        const autoStylesEl = this.contentXml.query("office:automatic-styles");
        autoStylesEl?.appendXML(`<style:style style:name="P${parStyleId}" style:family="paragraph" style:parent-style-name="Standard" text:list-style-name="L1" />`);
        return parStyleId;
    }
    addPageBreakStyle() {
        const stylesEl = this.stylesXml.query("office:styles");
        ...
        stylesEl?.appendXML('<style:style style:name="PageBreak" style:family="paragraph" style:parent-style-name="Standard" style:class="extra"><style:paragraph-properties fo:break-before="page"/></style:style>');
    }
