...
export class ODTExporterFootnotes {
    ...
    styleFilePath;
    styleXml;
    constructor(docContent, settings, xml, bodyCitations, styles, bibDB, imageDB, csl) {
    ...
    init() {
        ...
        if (this.footnotes.length ||
            ...
            this.citations = new ODTExporterCitations(this.fnPmJSON, this.settings, this.styles, this.bibDB, this.csl, this.bodyCitations.citInfos);
            this.images = new ODTExporterImages(this.fnPmJSON, this.xml, this.imageDB);
    ...
    setStyleConfig() {
        const oldFnStyleConfigEl = this.styleXml.query("text:notes-configuration", {
