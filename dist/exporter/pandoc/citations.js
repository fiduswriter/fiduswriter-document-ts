...
export class PandocExporterCitations {
    ...
    formatCitations() {
        ...
        const citFm = new FormatCitations(this.csl, this.citInfos, this.exporter.doc.settings.citationstyle || "", "", this.bibDB, false, this.exporter.doc.settings.language);
        this.citFm = citFm;
        return citFm.init().then(() => {
